...
public class MyProgressViewHolder extends RecyclerView.ViewHolder {
    ...
    public LinearLayout progressCardItemStatusImageViewWrapper;
    ...
    public MyProgressViewHolder(View itemView) {
        ...
        this.progressCardItemStatusImageViewWrapper = itemView.findViewById(R.id.progress_card_item_status_image_wrapper);
    }
}
